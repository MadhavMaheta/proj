<%-- 
    Document   : labo_Login
    Created on : 16 Jul, 2019, 5:33:21 PM
...
try{
    ...
    ResultSet rs=stmt.executeQuery("SELECT * from lab_info WHERE lab_name='"+admin_username+"' AND lab_Loginpassword='"+admin_password+"' ");
    if(rs.next()){
