<%-- 
    Document   : manage_Apn
    Created on : 4 Sep, 2019, 12:19:01 PM
	...
	<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<b><h1 class="mainTitle">Patient | Appointment</h1></b>
																	</div>
							</div>
						</section>
						<!-- end: PAGE TITLE -->
									...
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<p class="links cl-effect-1">
												<a href="updateprofile.jsp">Book Appointment</a>
											</p>
										</div>
									</div>
								</div>
